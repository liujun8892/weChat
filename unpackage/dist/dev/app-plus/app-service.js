...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;var _default = {\n  state: {\n    events: [] },\n\n  mutations: {\n    // 注册audio事件\n    regEvent: function regEvent(state, event) {\n      state.events.push(event);\n    },\n    // 消费事件\n    doEvent: function doEvent(state, params) {\n      state.events.forEach(function (e) {\n        __f__(\"log\", '消费', params, \" at store/modules/audio.js:13\");\n        e(params);\n      });\n    },\n    // 注销事件\n    destoryEvent: function destoryEvent(state, currentEvent) {\n      var index = state.events.findIndex(function (event) {return event === currentEvent;});\n      if (index !== -1) {\n        state.events.splice(index, 1);\n      }\n    } },\n\n  actions: {\n    // 全局注册事件\n    audioOn: function audioOn(_ref, event) {var commit = _ref.commit;\n      commit('regEvent', event);\n    },\n    // 全局消费事件\n    audioEmit: function audioEmit(_ref2, params) {var commit = _ref2.commit;\n      commit('doEvent', params);\n    },\n    // 全局注销事件\n    audioOff: function audioOff(_ref3, currentEvent) {var commit = _ref3.commit;\n      commit('destoryEvent', currentEvent);\n    } } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 5)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///12\n");
